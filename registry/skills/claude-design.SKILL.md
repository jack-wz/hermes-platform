...
skill_id: github/mikesheehan54/claude-code-design-ai
version: 1.0.0
description: "Claude Design: AI UI/UX architect. Screenshot to React, Figma components, Tailwind CSS generator. Prototyping agent, design systems, wireframe renderer. SVG icon creator, dark mode toggle, responsive "
author: mikesheehan54
source: https://github.com/mikesheehan54/Claude-Code-Design-AI
license: MIT
stars: 300
tags: ["claude-ai", "claude-code", "claude-code-cli", "claude-code-hooks", "claude-code-marketplace", "design", "ui", "ux"]
...
converted:
  from: github
  original_repo: mikesheehan54/Claude-Code-Design-AI
  converted_at: 2026-05-14T16:57:58Z
---
